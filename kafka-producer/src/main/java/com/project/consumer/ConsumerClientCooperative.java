...
public class ConsumerClientCooperative {
    private static final Logger logger = LoggerFactory.getLogger(ConsumerClientCooperative.class);
...
//        properties.setProperty("group.instance.id", "instance-1"); // strategy for static assignments
